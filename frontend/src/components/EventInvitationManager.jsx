...
const EventInvitationManager = ({ profileId, profileSlug, onClose }) => {
  ...
  const handleDeleteInvitation = async (invitationId) => {
    if (!window.confirm('Are you sure you want to delete this event invitation?')) {
      return;
    }

    try {
      await axios.delete(`${API_URL}/api/admin/event-invitations/${invitationId}`);
      fetchEventInvitations();
                      ...
                      <div className="flex justify-between items-center mb-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Design: {DESIGN_THEMES[invitation.design_id]?.name || invitation.design_id}
